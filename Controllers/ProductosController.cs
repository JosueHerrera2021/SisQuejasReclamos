...
namespace SisQuejasReclamos.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id_Producto,Nombre,Descripcion,Precio")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id_Producto,Nombre,Descripcion,Precio")] Producto producto)
        {
            if (ModelState.IsValid)
            {
